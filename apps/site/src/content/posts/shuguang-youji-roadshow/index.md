...
如果把这次路演当作一个内容节点，它在网站里的位置是“反馈入口”。项目页说明作品本身，复盘说明当时的开发判断，开发计划则承接这次现场观察。也就是说，路演不是单独的一篇活动记录，而是把两个项目从“已经做完”推向“继续迭代”的证据。

![《Emotion Mask》和《亚舍拉挽歌》的现场展位](/content-assets/posts/shuguang-youji-roadshow/booth-overview.png)
...
![现场玩家试玩两款游戏](/content-assets/posts/shuguang-youji-roadshow/booth-playtest.png)
...
![成都第一届《蜀光游集》活动合影](/content-assets/posts/shuguang-youji-roadshow/group-photo.jpg)
...
我也把这次路演之后的更新方向拆成了两份更具体的开发计划，后面会持续按版本调整：
...
后续我会把这类线下试玩记录继续作为版本决策依据，而不是只当作活动纪念。每一次路演、试玩或公开发布，都应该回答三个问题：玩家第一次接触时卡在哪里，哪些系统真的被理解了，下一版最值得优先改什么。
