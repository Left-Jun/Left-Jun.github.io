...
Echoes of Time is an early Limenauts team project created for the 2025 Autumn Sanjiao Cup Game Jam. I served as team lead, main designer, writer, and gameplay designer. My main contribution was compressing a broad timeline narrative into maps, props, NPCs, music goals, and daily deliverables the team could actually build. The player controls a cat-like mythical creature inspired by Huan from ancient Chinese mythology, traveling through ancient, modern, and future versions of the same place. Across the journey, the player collects instruments and melodies, eventually bringing the echoes of three eras into a future where music has disappeared.
...
![Opening setup](/content-assets/projects/time-echo/screenshot-opening.png)
...
![Ancient musician dialogue](/content-assets/projects/time-echo/screenshot-ancient-dialogue.png)

The ancient act connects the flute and musician to the theme of awe, tying music to nature, mountains, and older memories.

![Ancient platforming scene](/content-assets/projects/time-echo/screenshot-ancient-platforming.png)

The ancient level uses ink-wash mountains, bamboo, clouds, and light platforms to create a poetic sense of movement.

![Modern scene with guitarist](/content-assets/projects/time-echo/screenshot-modern-scene.png)

The modern act places the park, fountain, guitarist, and time gate in one scene, carrying the melody of remembrance.

![Future tower platforming](/content-assets/projects/time-echo/screenshot-future-platforming.png)
...
![Echoes of Time era flow](/content-assets/projects/time-echo/flow-system-en.svg)
