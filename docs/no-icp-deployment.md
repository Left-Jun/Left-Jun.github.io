...
- 加速区域：**不含中国大陆，全球加速**（当前已启用此配置）

当前项目已切换到"不含中国大陆，全球加速"模式，可在未备案状态下正常使用自定义域名。此配置为平台侧设置，无需代码层面额外配置。

<!-- 备案完成后如需切换到含中国大陆加速区域，请在 EdgeOne Pages 控制台修改加速区域设置，并确认已完成域名备案，再添加备案号信息。 -->
...
<!-- 备案后（可选）：
- `example.com` 切换到 EdgeOne 全球含中国大陆加速，或腾讯云 COS + CDN
- 页脚增加备案号链接
